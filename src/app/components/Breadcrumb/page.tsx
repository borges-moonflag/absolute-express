...
export default function Breadcrumb() {
    ...
    const sobreNos = {
        background: "./sobre-nos-background.webp"
    }
        ...
        <section className="w-full flex">
            <div className="w-full flex">
                <div className="w-1/2 bg-[var(--primary-tree)] flex items-center justify-end max-[1160px]:w-full max-[1160px]:justify-start max-[1160px]:px-7.5">
                    <div className="flex flex-col gap-[23px] pr-[168px] py-[104px] max-[1160px]:pr-0">
                        <h1 className="font-montserrat text-[16px] font-medium leading-6 uppercase text-[var(--color-white)]">Escritório de contabilidade em maceió</h1>
                        <h2 className="font-sora text-[36px] font-normal leading-[44px] text-[var(--color-white)]">Conheça a <br /><span className="font-bold">nossa história</span></h2>
