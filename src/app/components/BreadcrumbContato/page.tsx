...
export default function BreadcrumbContato() {

    const sobreNos = {
        background: "./contato-background.webp"
    }
            ...
            <div className="w-full flex">
                <div className="w-1/2 bg-[var(--primary-tree)] flex items-center justify-end max-[1160px]:w-full max-[1160px]:justify-start max-[1160px]:px-7.5">
                    <div className="w-fit flex flex-col gap-[23px] pr-[168px] py-[104px] max-[1160px]:pr-0">
                        <h1 className="font-montserrat text-[16px] font-medium leading-6 uppercase text-[var(--color-white)]">contabilidade alagoas</h1>
                        <h2 className="font-sora text-[36px] font-normal leading-[44px] text-[var(--color-white)]">Fale já com nossos <span className="font-bold"><br/>especialistas</span></h2>
