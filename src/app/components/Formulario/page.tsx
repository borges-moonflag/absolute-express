        ...
        <section className="w-full flex items-center justify-center bg-[var(--primary-tree)] pt-[100px] pb-[121px]">
            <div className="max-w-[1140px] gap-[43px] flex justify-between items-center max-[1150px]:flex-col">
                <div className="flex flex-col gap-8 max-[1150px]:items-center max-[1150px]:text-center ">
                    <h2 className="max-w-[566px] font-sora text-[46px] font-normal leading-[54px] text-[var(--color-white)] max-[612px]:text-[28px] max-[612px]:leading-[36px] max-sm:text-center">Conte com a Absolute: absolutamente parceira</h2>
                    <p className="max-w-[425px] font-montserrat text-[16px] font-normal leading-6 text-[var(--color-white)] max-sm:px-4 ">Preencha o formulário e descubra como a Absolute pode transformar sua contabilidade em estratégia para o crescimento da sua empresa.</p>
